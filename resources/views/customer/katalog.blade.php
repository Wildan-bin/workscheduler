<x-layout>
    ...
    <br>
    <div id="" class="max-w-4xl mx-auto grid grid-cols-2 gap-4 p-2">
        @foreach($produks as $product)
        <div class="bg-white p-3 rounded-lg shadow-md border-2 border-[#CD9C20]">
            <img src="{{$product->image}}" alt="{{$product->image}}" class="w-full h-48 object-cover rounded-lg">
    ...
    <!-- <script>
        ...
        const products = {
            men: [{
                    name: "Men's Fragrance 1",
                    image: "https://i.pinimg.com/564x/b8/fa/ca/b8facaf5540f5dd200bb7ec664861c1a.jpg"
                },
                {
                    name: "Men's Fragrance 2",
                    image: "https://i.pinimg.com/564x/b8/fa/ca/b8facaf5540f5dd200bb7ec664861c1a.jpg"
                },
                {
                    name: "Men's Fragrance 3",
                    image: "https://i.pinimg.com/564x/b8/fa/ca/b8facaf5540f5dd200bb7ec664861c1a.jpg"
                },
                {
                    name: "Men's Fragrance 4",
                    image: "https://i.pinimg.com/564x/b8/fa/ca/b8facaf5540f5dd200bb7ec664861c1a.jpg"
                },
            ],
            woman: [{
                    name: "Victoria's Secret Scandal",
                    image: "https://i.pinimg.com/564x/b8/fa/ca/b8facaf5540f5dd200bb7ec664861c1a.jpg"
                },
                {
                    name: "Women's Fragrance 2",
                    image: "https://i.pinimg.com/564x/b8/fa/ca/b8facaf5540f5dd200bb7ec664861c1a.jpg"
                },
                {
                    name: "Women's Fragrance 3",
                    image: "https://i.pinimg.com/564x/b8/fa/ca/b8facaf5540f5dd200bb7ec664861c1a.jpg"
                },
                {
                    name: "Women's Fragrance 4",
                    image: "https://i.pinimg.com/564x/b8/fa/ca/b8facaf5540f5dd200bb7ec664861c1a.jpg"
                },
            ]
        };
